...
IDRS_Test Plan_V.0.2.0 — Chapter 3.2 "AI Detection Results Module":
  ...
  UTC-42 : Run AI Detection on Panoramic X-ray -> create_ai_detection_result()
  UTC-43 : View AI Detection Results           -> get_ai_detection_analyses_by_chart_id()
...
# ---------------------------------------------------------------------------
# Constants (match UTC-42 / UTC-43 in the Test Plan)
# ---------------------------------------------------------------------------
...
# ===========================================================================
# UTC-42 : Run AI Detection on Panoramic X-ray
# ===========================================================================
class TestRunAIDetection:

    def test_utc_42_tc_01_success_on_panoramic_xray(self, mock_session, monkeypatch):
    ...
    def test_utc_42_tc_02_image_does_not_exist(self, mock_session, monkeypatch):
    ...
    def test_utc_42_tc_03_image_is_not_panoramic_xray(self, mock_session, monkeypatch):
    ...
    def test_utc_42_tc_04_ai_model_inference_fails(self, mock_session, monkeypatch):
        ...
        predict = MagicMock(side_effect=RuntimeError("model crashed"))
        monkeypatch.setattr(svc.ai_inference, "predict", predict)
        ...
        assert exc.value.detail == "AI model inference failed"
        mock_session.add.assert_not_called()
        mock_session.commit.assert_not_called()


# ===========================================================================
# UTC-43 : View AI Detection Results
# ===========================================================================
class TestViewAIDetectionResults:

    def test_utc_43_tc_01_chart_has_analysis_records(self, mock_session):
    ...
    def test_utc_43_tc_02_chart_has_no_analysis_records(self, mock_session):
    ...
    def test_utc_43_tc_03_chart_id_does_not_exist(self, mock_session):
    ...
    def test_utc_43_tc_03_chart_id_missing(self, mock_session):
